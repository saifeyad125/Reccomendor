...
#if sentiment is empty we want to drop the column
...
#show the top 10 games and have them till 3 significan figures
show_dataframe_popup(grouped_data.head(10).round(3))
